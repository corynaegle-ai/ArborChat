...
import { X, User, Check, Search, Loader2, Sparkles } from 'lucide-react'
  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="max-h-80 overflow-y-auto p-3 scrollbar-thin">
          {loading ? (
            ...
            <div className="py-12 text-center">
              ...
              <p className="text-xs text-text-muted">
                {search ? 'Try a different search term' : 'Create personas in Settings → Personas'}
              </p>
            </div>
          ) : (
                  ...
                  >
                    ...
                    <div
                      className={cn(
                        ...
                        isActive ? 'border-primary bg-primary' : 'border-text-muted/30'
                      )}
                    >
        ...
        {/* Footer hint */}
        <div
          className={cn('p-3 border-t border-secondary/50', 'text-xs text-text-muted text-center')}
        >
          <span>Type </span>
