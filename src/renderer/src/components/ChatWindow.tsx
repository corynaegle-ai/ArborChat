    ...
    return (
        ...
        >
            ...
            <div className={cn(
                ...
                <span className={cn(
                    "text-xs font-medium",
                    isAssistant ? "text-primary" : "text-emerald-400"
                )}>
    ...
    return (
        <div className="flex-1 flex flex-col items-center justify-center text-center px-4">
            ...
            <p className="text-sm text-text-muted max-w-sm">
                Ask me anything. When I respond, hover over my message to start a focused thread for follow-up questions.
            </p>
        </div>
    )
}
    ...
    return (
        <div className={cn(
            ...
            <div className={cn(
                ...
                <form onSubmit={handleSubmit} className="relative max-w-4xl lg:max-w-5xl xl:max-w-6xl mx-auto">
                    <div className={cn(
